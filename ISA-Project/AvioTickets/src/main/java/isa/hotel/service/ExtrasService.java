...
public class ExtrasService {
	...
	public boolean add(ExtrasDTO extrasDTO, Long hotelID) {
		...
		if(extrasRepository.findAllByHotelID(extrasDTO.getHotelID()).stream().filter(x -> extrasDTO.getName().equals(x.getName())).map(this::convertToDTO).collect(Collectors.toList()).isEmpty()) {
